...
class Qwen3_5GatedDeltaNet(nn.Module):
    ...
    def __init__(
        ...
        self.in_proj_qkv = ColumnParallelLinear(
            ...
            bias=False,
            quant_config=quant_config,
            prefix=f"{prefix}.in_proj_qkv" if prefix else None,
        )
        self.in_proj_z = ColumnParallelLinear(
            ...
            bias=False,
            quant_config=quant_config,
            prefix=f"{prefix}.in_proj_z" if prefix else None,
        )
        self.in_proj_b = ColumnParallelLinear(
            ...
            bias=False,
            quant_config=quant_config,
            prefix=f"{prefix}.in_proj_b" if prefix else None,
        )
        self.in_proj_a = ColumnParallelLinear(
            ...
            bias=False,
            quant_config=quant_config,
            prefix=f"{prefix}.in_proj_a" if prefix else None,
        )
        ...
        self.out_proj = RowParallelLinear(
            ...
            bias=False,
            quant_config=quant_config,
            prefix=f"{prefix}.out_proj" if prefix else None,
        )
...
class Qwen3_5TextModel(nn.Module):
    ...
    def __init__(
        ...
        self.layers = nn.ModuleList(
            [Qwen3_5DecoderLayer(config, layer_idx, quant_config=quant_config) for layer_idx in range(config.num_hidden_layers)]
        )
...
class Qwen3_5Model(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.language_model = Qwen3_5TextModel(config, quant_config=quant_config)
